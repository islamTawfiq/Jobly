...
class exportAgenciesController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $users = User::where(['user_type_id' => 5 , 'active' => 1])->latest()->get();
            return DataTables::of($users)->make(true);
        }
        return view('admin.users.agencies.export.exportAgency');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.users.agencies.export.edit', compact('user'));
    }
