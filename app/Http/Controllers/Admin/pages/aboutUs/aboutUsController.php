...
class aboutUsController extends Controller
{
   ...
   public function update(Request $request)
   {
       ...
       $data = $request->validate([
           ...
           'img1' => 'sometimes|nullable|image',
           'img2' => 'sometimes|nullable|image',
           'img3' => 'sometimes|nullable|image',
           'img4' => 'sometimes|nullable|image',
       ]);

       if( $request->hasFile('img1')) {
        !empty($item->img1)?Storage::delete($item->img1):'';
        $data['img1'] = $this->storeFile($request->img1, 'about-us');
       }
