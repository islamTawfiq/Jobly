                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-12 text-md-right rightButtons">
                                        <a href="{{ url('/import-agency-dashboard/aprove/') . '/' . $nanny->id }}" class="btn btn-success btnDashboard">Approve</a>
                                        <a href="{{ url('/import-agency-dashboard/cancel/') . '/' . $nanny->id }}" class="btn btn-danger btnDashboard">Reject</a>
                                    </div>
                                </div>
                            </div>
