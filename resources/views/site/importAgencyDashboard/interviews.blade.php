                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-12 text-md-right rightButtons">
                                        <a href="{{ url('/import-agency-dashboard/aprove/') . '/' . $nanny->id }}" class="btn btn-success">Approve</a>
                                        <a href="{{ url('/import-agency-dashboard/cancel/') . '/' . $nanny->id }}" class="btn btn-danger">Reject</a>
                                    </div>
                                    <div class="col-12">
                                        {{--  <!-- Button trigger modal -->  --}}
                                        <button type="button" class="btn btn-primary mt-2 mt-md-0" style="font-size: 13px" data-toggle="modal" data-target="#dl-{{ $nanny->id }}">See All Details</button>
                                        {{--  <!-- Modal -->  --}}
                                        <div class="modal fade" id="dl-{{ $nanny->id }}" tabindex="-1" role="dialog" aria-labelledby="detailsCenterTitle" aria-hidden="true">
