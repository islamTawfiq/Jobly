                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-12 text-md-right rightButtons mb-2 mb-md-0">
                                        @if ($nanny->status == 1)
                                            <a href="{{ url('/import-agency-dashboard/cancel/') . '/' . $nanny->id }}" class="btn btn-danger btnDashboard mb-2">Cancel</a>
                                    ...
                                    <div class="col-12 m-2">
                                        <form method="POST" action="{{ url('/import-agency-dashboard/notes/') . '/' . $nanny->nanny_id . '/' . $nanny->workers->broker->id }}">
                                            @csrf
