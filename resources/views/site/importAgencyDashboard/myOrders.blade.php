                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <button type="button" class="btn btn-primary mt-2 mt-md-0" style="font-size: 13px" data-toggle="modal" data-target="#det-{{ $nanny->id }}">See All Details</button>
                                        {{--  <!-- Modal -->  --}}
                                        <div class="modal fade" id="det-{{ $nanny->id }}" tabindex="-1" role="dialog" aria-labelledby="detailsCenterTitle" aria-hidden="true">
