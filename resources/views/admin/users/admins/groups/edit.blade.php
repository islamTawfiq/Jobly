                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @include('admin.components.inputs.check', [
                                                                        ...
                                                                        'value' => '1',
                                                                        'label' => '',
                                                                        'checked' => $item->sponsors_show == '1' ? true : false,
                                                                        'disabled' => false,
                                                                        ])
                                                                </td>
                                                                <td>
                                                                    @include('admin.components.inputs.check', [
                                                                        ...
                                                                        'value' => '1',
                                                                        'label' => '',
                                                                        'checked' => $item->sponsors_add == '1' ? true : false,
                                                                        'disabled' => false,
                                                                        ])
                                                                </td>
                                                                <td>
                                                                    @include('admin.components.inputs.check', [
                                                                        ...
                                                                        'value' => '1',
                                                                        'label' => '',
                                                                      'checked' => $item->sponsors_edit == '1' ? true : false,
                                                                        'disabled' => false,
                                                                        ])
                                                                </td>
                                                                ...
                                                                <td>
                                                                    @include('admin.components.inputs.check', [
                                                                        ...
                                                                        'value' => '1',
                                                                        'label' => '',
                                                                         'checked' => $item->sponsors_delete == '1' ? true : false,
                                                                        'disabled' => false,
                                                                        ])
                                                                </td>
                                                            </tr>
