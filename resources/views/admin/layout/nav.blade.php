            ...
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link"
                            ...
                            <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">Name</span><span
                                    class="user-status">User Email</span></div>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item"  href="" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="feather icon-power"></i>{{trans('web.logout')}}</a>
